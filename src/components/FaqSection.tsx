...
export const FaqSection: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'عند الضغط على أي منتج، يمكنك تحديد الوزن بدقة (حتى 250 جرام)، واختيار طريقة التقطيع (مكعبات، شرائح، ستيك، شاورما، مفروم)، ونسبة الدهن، وطريقة التغليف (أطباق عادي أو كيس ثلج أو تغليف هدايا).'
    },
    {
